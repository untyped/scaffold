...
(define-class self-hiding-combo-box% combo-box% ()
  (inherit get-options)
...
(define-mixin report-pager-mixin (html-element<%>) (report-pager<%>)
...
(define-class quick-report-pager% (report-pager-mixin html-element%) ()
...
(define-class linked-report-pager% (report-pager-mixin html-element%) ()
