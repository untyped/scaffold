...
(define-mixin attribute-editor-mixin (form-element<%> labelled-element<%> editor<%> check-label<%>) (attribute-editor<%>)
...
(define-class simple-attribute-editor% 
  (labelled-element-mixin (check-label-mixin (simple-editor-mixin form-element%))) (attribute-editor<%>)
