...
(define/provide-test-suite delete-tests
  ...
  (test-case "page title and structure"
    (before (begin (recreate-test-data!))
            (begin (open/wait (controller-url sink-delete test-sink))
